    ...
    <Section>
      ...
      >
        ...
        <h4 className="text-[clamp(40px,7vw,110px)] font-sans font-medium text-right text-black mb-12 leading-tight text-balance">
          From Observations to Format Blueprint
        </h4>
          ...
          <div className="md:border-r md:border-border/10 md:pr-10 flex flex-col justify-center space-y-8">
            ...
            >
              ...
              <p className="text-xs md:text-sm text-black/70 leading-relaxed font-light">
                Rather than traditional market research, discovery focused on
                how audiences engage with artists in short-form environments.
                <span className="font-medium text-black">
                  {" "}
                  Presence, consistency, and conversational tone
                </span>{" "}
            ...
            >
              ...
              <p className="text-xs md:text-sm text-black/70 leading-relaxed font-light">
                ...
                <span className="font-medium text-black">
                  familiar formats performed better
                </span>{" "}
                than experimental content, suggesting audiences valued
                predictability in how they connected with creators.
              </p>
            </motion.div>
            ...
            >
              <h3 className="text-base md:text-lg font-sans font-semibold text-black mb-1">
                Format Constraints Definition
              </h3>
              <p className="text-xs md:text-sm text-black/70 leading-relaxed font-light">
                These insights informed a set of{" "}
                <span className="font-medium text-black">
                  format constraints that preserved creative freedom
                </span>
                while enabling repetition and scale.
              </p>
            </motion.div>
          </div>
            ...
            {[
              {
                ...
                title: "Content Audit",
                text: "Analysis of successful short-form creators to identify engagement patterns and format consistency.",
              },
              {
                icon: <BookOpen className="w-6 h-6 text-accent" />,
                title: "Format Framework",
                text: "Development of repeatable content structure that balances spontaneity with strategic objectives.",
              },
              {
                icon: <Lightbulb className="w-6 h-6 text-accent" />,
                title: "Success Metrics",
                text: "Definition of early indicators beyond reach, focusing on engagement quality and audience retention.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
