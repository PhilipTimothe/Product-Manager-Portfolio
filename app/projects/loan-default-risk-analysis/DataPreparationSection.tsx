            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-xs md:text-sm text-black/70 leading-relaxed font-light">
                  Cleaned missing and inconsistent payment data, handling null values and 
                  standardizing financial metrics across the dataset.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs md:text-sm text-black/70 leading-relaxed font-light">
                  ...
                  and improve model's ability to detect defaults.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="text-xs md:text-sm text-black/70 leading-relaxed font-light">
                  Engineered new features including repayment history flags and credit 
                  utilization ratios to capture risk patterns.
                </p>
              </div>
            </div>
          </div>
