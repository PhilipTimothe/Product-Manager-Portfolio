...
export const caseStudies: Project[] = [
  ...
  },
  {
    ...
    description:
      "I developed predictive models to analyze loan default patterns and identify high-risk borrowers. By combining data preprocessing, feature engineering, and advanced modeling, I built insights and recommendations to help financial institutions reduce defaults and improve lending strategies.",
  },
];
